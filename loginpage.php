...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $stmt = $pdo->prepare("INSERT INTO users (name, email, phone, address, password, gender) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->execute([$name, $email, $phone, $address, $password, $gender]);
...
<head>
    ...
    <script>
        ...
        function validateForm() {
            // Additional validation for gender (radio button)
...
<body>
    <div class="container">
        ...
        <form action="/ats/folder/form.php" method="post" onsubmit="return validateForm()">
            ...
            <div class="mb-3">
                <label for="profilePhoto" class="form-label">Upload your profile photo</label>
                <input type="file" class="form-control" id="profilePhoto" name="profilePhoto" accept="image/*">
                <div id="profilePhotoError" class="form-text text-muted"></div>
            </div>
